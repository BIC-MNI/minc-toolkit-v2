...
file(READ "${staging_prefix}/${install_prefix}/lib/cmake/ITK-4.11/Modules/ITKMINC.cmake" config_file)
...
file(WRITE "${staging_prefix}/${install_prefix}/lib/cmake/ITK-4.11/Modules/ITKMINC.cmake" "${config_file}")
