...
FOREACH(conf "ITKTargets-release.cmake" "Modules/ITKZLIB.cmake" "Modules/ITKZLIB.cmake" "Modules/ITKMINC.cmake" "Modules/ITKHDF5.cmake")
  if (EXISTS "${staging_prefix}/${install_prefix}/lib/cmake/ITK-4.8/${conf}")
    patch_itk_config("${staging_prefix}/${install_prefix}/lib/cmake/ITK-4.8/${conf}" "${staging_prefix}")
  endif()
ENDFOREACH(conf)


# a hack to remove internal minc directories
file(READ "${staging_prefix}/${install_prefix}/lib/cmake/ITK-4.8/Modules/ITKMINC.cmake" config_file)
...
file(WRITE "${staging_prefix}/${install_prefix}/lib/cmake/ITK-4.8/Modules/ITKMINC.cmake" "${config_file}")
