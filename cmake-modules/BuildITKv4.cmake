macro(build_itkv4 install_prefix staging_prefix minc_dir hdf_bin_dir hdf_include_dir hdf_library_dir zlib_include_dir zlib_library)
  ...
  ExternalProject_Add(ITKv4
    ...
    PATCH_COMMAND patch -p 1 -d ${CMAKE_CURRENT_BINARY_DIR}/ITKv4 -u -i ${CMAKE_CURRENT_SOURCE_DIR}/cmake-modules/0001-BUG-Missing-ITKIOMINC_EXPORT-on-__Private.patch -s && patch -p 1 -d ${CMAKE_CURRENT_BINARY_DIR}/ITKv4 -u -i ${CMAKE_CURRENT_SOURCE_DIR}/cmake-modules/0001-COMP-Fixes-issue-when-MINCTransformation-module-is-n.patch -s
    UPDATE_COMMAND ""
    SOURCE_DIR ITKv4
